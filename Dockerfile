...
RUN apk add --no-cache python3 nmap nano htop tcpdump which curl wget npm ca-certificates jq
...
RUN apk add --no-cache go-c8y-cli --repository=https://reubenmiller.github.io/go-c8y-cli-repo/alpine/stable/main
